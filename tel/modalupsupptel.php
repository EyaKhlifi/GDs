<!-- Modal supp -->
<div class="modal fade" id="supptel_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="tel/supp_tel.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modiftel_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="tel/modif_tel.php" method="post">
                <div class="modal-body">
                    <div class="row">
