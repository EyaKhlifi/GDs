...
<!-- Modal supp -->
<div class="modal fade" id="supplap_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="pc/supp_lap.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modiflap_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="pc/modif_lap.php" method="post">
                <div class="modal-body">
                    <div class="row">
