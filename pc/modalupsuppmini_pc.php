<!-- Modal supp -->
<div class="modal fade" id="supp_mini_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="pc/supp_minipc.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modifmini_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="pc/modifmini_pc.php" method="post">
                <div class="modal-body">
                    <div class="row">
