...
<!-- Modal supp -->
<div class="modal fade" id="supp_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="pc/supp_bureau.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modif_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="pc/modif.php" method="post">
                <div class="modal-body">
                    <div class="row">
