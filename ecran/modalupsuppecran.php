<!-- Modal supp -->
<div class="modal fade" id="suppecran_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="ecran/supp_ecran.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modifecran_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="ecran/modif_ecran.php" method="post">
                <div class="modal-body">
                    <div class="row">
