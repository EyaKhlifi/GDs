<!-- Modal supp -->
<div class="modal fade" id="suppserv_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="serveur/supp_serveur.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modifserv_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="serveur/modif_serveur.php" method="post">
                <div class="modal-body">
                    <div class="row">
