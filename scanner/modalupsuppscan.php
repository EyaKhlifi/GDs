<!-- Modal supp -->
<div class="modal fade" id="suppscan_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="scanner/supp_scanner.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modifscan_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="scanner/modif_scanner.php" method="post">
                <div class="modal-body">
                    <div class="row">
