<!-- Modal supp -->
<div class="modal fade" id="suppswitch_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="switch/supp_switch.php" method="post">
...
<!-- Modal modif -->
<div class="modal fade" id="modifswirch_<?php echo $fetchs['id'];?>">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="switch/modif_switch.php" method="post">
                <div class="modal-body">
                    <div class="row">
